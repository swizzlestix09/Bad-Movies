...
let genresSearch = (id) => {
  let options = {
    method: "GET",
    url: `https://api.themoviedb.org/3/discover/movie?api_key=${API_KEY}&language=en-US&region=US&sort_by=popularity.asc&include_adult=false&include_video=false&page=1&with_genres=${id}&with_watch_monetization_types=flatrate`,
    headers: {
      "User-Agent": "request",
      "Content-Type": "application/json;charset=utf-8",
      Authorization: "d6d371fbeb2fcc92cdcb10e6f6b97b97",
